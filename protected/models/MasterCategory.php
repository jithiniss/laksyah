 ...
 * @property string $dou
 */
class MasterCategory extends CActiveRecord {
        ...
        public function rules() {
                ...
                return array(
                    //array('category_name, status, cb, ub, doc', 'required'),
                    array('status, cb, ub', 'numerical', 'integerOnly' => true),
                    array('category_name', 'length', 'max' => 225),
                    array('dou', 'safe'),
                    // The following rule is used by search().
                    // @todo Please remove those attributes that should not be searched.
                    array('id, category_name, status, cb, ub, doc, dou', 'safe', 'on' => 'search'),
                );
        }
