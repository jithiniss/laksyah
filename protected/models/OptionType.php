 ...
 * @property OptionCategory[] $optionCategories
 */
class OptionType extends CActiveRecord
{
	...
	public function rules()
	{
		...
		return array(
			array('type, field1, field2', 'required'),
			array('field1, field2', 'numerical', 'integerOnly'=>true),
			array('type', 'length', 'max'=>100),
			// The following rule is used by search().
			// @todo Please remove those attributes that should not be searched.
			array('id, type, field1, field2', 'safe', 'on'=>'search'),
		);
	}
	...
	public function relations()
	{
		...
		return array(
			'optionCategories' => array(self::HAS_MANY, 'OptionCategory', 'option_type_id'),
		);
	}
