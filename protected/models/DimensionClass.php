...
/**
 * This is the model class for table "dimension_class".
 *
 * The followings are the available columns in table 'dimension_class':
 * @property integer $id
 ...
 * @property string $DOU
 */
class DimensionClass extends CActiveRecord {
         ...
         * @return DimensionClass the static model class
         */
