...
<div class="form">
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10">
            <?php echo $form->dropDownList($model, 'category_id', CHtml::listData(HomeCategory::model()->findAll(), 'id', 'category_name'), array('class' => 'form-control', 'empty' => '--Select  category--')); ?>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10"><?php echo $form->textField($model, 'title', array('size' => 60, 'maxlength' => 100, 'class' => 'form-control')); ?>
        </div>
    ...
    <div class="form-group">
        ...
        <div class="col-sm-10"><?php echo $form->textField($model, 'link', array('size' => 60, 'maxlength' => 100, 'class' => 'form-control')); ?>
        </div>
