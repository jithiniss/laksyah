...
class HomeCategoryController extends Controller {
        ...
        public function actionCreate() {
                ...
                if (isset($_POST['HomeCategory'])) {
                        $model->attributes = $_POST['HomeCategory'];
        ...
        public function actionIndex() {
                $dataProvider = new CActiveDataProvider('HomeCategory');
        ...
        public function actionAdmin() {
                $model = new HomeCategory('search');
                $model->unsetAttributes();  // clear any default values
                if (isset($_GET['HomeCategory']))
                        $model->attributes = $_GET['HomeCategory'];
        ...
        public function loadModel($id) {
                $model = HomeCategory::model()->findByPk($id);
                if ($model === null)
         ...
         * @param HomeCategory $model the model to be validated
         */
        protected function performAjaxValidation($model) {
                if (isset($_POST['ajax']) && $_POST['ajax'] === 'home-category-form') {
