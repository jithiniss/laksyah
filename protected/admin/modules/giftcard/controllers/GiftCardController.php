...
class GiftCardController extends Controller {
        ...
        public function init() {
                if (!isset(Yii::app()->session['admin']) || Yii::app()->session['post']['coupons'] != 1) {
        ...
        public function actionCreate() {
                ...
                if (isset($_POST['GiftCard'])) {
                        ...
                        if ($model->save()) {
                                if ($image != "") {
                                        $image->saveAs(Yii::app()->basePath . "/../uploads/gift/" . $model->id . "." . $image->extensionName);
                                }
                                Yii::app()->user->setFlash('success', "File Uploded Successfully");
