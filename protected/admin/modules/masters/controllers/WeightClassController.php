...
class WeightClassController extends Controller {
        ...
        public function actionCreate() {
                $model = new WeightClass('create');

                // Uncomment the following line if AJAX validation is needed
                // $this->performAjaxValidation($model);

                if (isset($_POST['WeightClass'])) {
                        $model->attributes = $_POST['WeightClass'];
        ...
        public function actionIndex() {
                $dataProvider = new CActiveDataProvider('WeightClass');
        ...
        public function actionAdmin() {
                ...
                if (isset($_GET['WeightClass']))
                        $model->attributes = $_GET['WeightClass'];
        ...
        public function loadModel($id) {
                $model = WeightClass::model()->findByPk($id);
                if ($model === null)
         ...
         * @param WeightClass $model the model to be validated
         */
        protected function performAjaxValidation($model) {
                if (isset($_POST['ajax']) && $_POST['ajax'] === 'weight-class-form') {
