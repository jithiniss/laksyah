...
<?php $form=$this->beginWidget('CActiveForm', array(
	...
	<div class="row">
		...
		<?php echo $form->textField($model,'small_image',array('size'=>20,'maxlength'=>20,'class' => 'form-control')); ?>
	</div>

	<div class="row">
		<?php echo $form->label($model,'big_image'); ?>
		<?php echo $form->textField($model,'big_image',array('size'=>20,'maxlength'=>20,'class' => 'form-control')); ?>
	</div>
