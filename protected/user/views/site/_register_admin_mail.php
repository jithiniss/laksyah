            ...
            <table id="Table_01" width="776" border="0" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr>
                    <td style="padding:40px 20px; font-family:'Open Sans',arial, sans-serif; font-size:13px"><p>Hi Admin,</p>
                        ...
                        <p style=" font-family:'Open Sans',arial, sans-serif; font-size:13px;">New accont has been created</p>
                        <p style=" font-family:'Open Sans',arial, sans-serif; font-size:13px;"> USER NAME: <?php echo $model->first_name; ?> ON  <?php echo $newDate = date("d-m-Y", strtotime($model->DOC)); ?></p>
<!--                        <p style=" font-family:'Open Sans',arial, sans-serif; font-size:13px;"><a href="#" style="text-transform: uppercase;background-color: #f47721;border-radius: 0;outline: none;border: none;height: 40px;line-height: 40px;padding: 0px 10px;padding-left: 30px;padding-right: 30px; color:#fff; text-decoration:none; display:inline-block;">VIEW MY ACCOUNT</a></p>-->
