            ...
            <table id="Table_01" width="776" border="0" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr>
                    <td style="padding:40px 20px; font-family:'Open Sans',arial, sans-serif; font-size:13px"><p>Hi <?php echo $model->first_name; ?><span>      <?php echo $model->last_name; ?></span>,</p>
                        <p style=" font-family:'Open Sans',arial, sans-serif; font-size:13px;">Greetings!</p>
                        <p style=" font-family:'Open Sans',arial, sans-serif; font-size:13px;">Your OTP: <?php echo $model->verify_code; ?></p>
                        <p style=" font-family:'Open Sans',arial, sans-serif; font-size:13px;">Treat this as confidential. Sharing anyone with anyone gives them full access to your laksyah account.</p>
