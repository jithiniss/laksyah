...
Editing:
/home/betalaksyah/public_html/hdfcpay/confirm.php
...
<HTML>
        ...
        <center>
                ...
                <?php
                if ($response['Description'] == "Laksyah Products") {
                        if ($response['paymentStatus'] == "SUCCESS") {
                                header("location:http://beta.laksyah.com/index.php/CheckOut/OrderSuccess/payid/" . $response['PaymentID']);
                        } else {
                                header("location:http://beta.laksyah.com/index.php/CheckOut/OrderFailed");
                        }
                } else if ($response['Description'] == "Laksyah Payment") {
                        if ($response['paymentStatus'] == "SUCCESS") {
                                header("location:http://beta.laksyah.com/index.php/myAccount/MakePaymentSuccess/enquiry_id/" . $response['DeliveryAddress'] . "/history_id/" . $response['DeliveryCity'] . "/payment_id/" . $response['DeliveryState'] . "/tranid/" . $response['PaymentID']);
                        } else {
                                header("location:http://beta.laksyah.com/index.php/myAccount/MakePaymentError");
                        }
                } else if ($response['Description'] == "Laksyah Wallet") {
                        if ($response['paymentStatus'] == "SUCCESS") {
                                header("location:http://beta.laksyah.com/index.php/myWallet/CreditSuccess/payid/" . $response['PaymentID'] . "/user_id/" . $response['DeliveryState'] . "/wallet_id/" . $response['DeliveryCity']);
                        } else {
                                header("location:http://beta.laksyah.com/index.php/myWallet/CreditError");
                        }
                }
                ?>
