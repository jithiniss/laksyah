                                ...
                                <div class="container">
                                        <div class="row">
                                                <div class="col-sm-5 hidden-xs">
                                                        ...
                                                        <form action="<?php echo Yii::app()->request->baseUrl; ?>/index.php/Search/Search" method="post">
                                                                        ...
                                                                        <li class="my_account has_dropdown"><span class="account_icon"><i class="fa fa-user"></i></span><span class="account_title">My Account</span> <i class="fa fa-angle-down"></i>
                                                                                <div class="laksyah_dropdown">
                                                                                        <ul class="drop_menu">
                                                                                                ...
                                                                                                <li><a href="<?= Yii::app()->baseUrl; ?>/index.php/Myaccount/Myorders" class="currency" >My Orders</a></li>
                        ...
                        <div class="footer_content">
                                <div class="container">
                                        ...
                                        <div class="footer_bottom">
                                                <div class="container">
                                                        <div class="col-card"> <span class="text_RR"><img src="images/card-icons.png"></span>
