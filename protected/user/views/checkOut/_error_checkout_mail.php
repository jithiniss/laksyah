    ...
    <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <div style="margin:auto; width:776px; border:solid 2px #404241; margin-top:40px; margin-bottom:40px;">
            <table id="Table_01" width="776" border="0" cellpadding="0" cellspacing="0" align="center">
                ...
                <tr>
                    <td style="padding:40px 20px; font-family:'Open Sans',arial, sans-serif; font-size:13px"><p>Hi <?php echo $userdetails->first_name; ?><span>      <?php echo $userdetails->last_name; ?></span>,</p>
                        <p style=" font-family:'Open Sans',arial, sans-serif; font-size:13px;"></p>
                        <p style=" font-family:'Open Sans',arial, sans-serif; font-size:13px;">  Oops some error occured
                        </p>
