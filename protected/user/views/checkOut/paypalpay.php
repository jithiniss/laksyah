<form name=paypal action='https://www.sandbox.paypal.com/cgi-bin/webscr' method='post'>
        ...
        <input type='hidden' name='return' value='<?php echo Yii::app()->request->baseUrl; ?>/index.php/CheckOut/CheckOut/OrderSuccess'>
        <input type='hidden' name='cancel' value='<?php echo Yii::app()->request->baseUrl; ?>/index.php/CheckOut/CheckOut/OrderFailed'>
