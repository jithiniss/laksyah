    ...
    <body bgcolor="#FFFFFF" leftmargin="0" topmargin="0" marginwidth="0" marginheight="0">
        ...
        <div style="margin:auto; width:776px; border:solid 2px #404241; margin-top:40px; margin-bottom:40px;">
            <table id="Table_01" width="776" border="0" cellpadding="0" cellspacing="0" align="center" style=" font-family: 'Open Sans',arial, sans-serif;">
                ...
                <tr>
                    <td valign="top">
                        <h1 style="font-size:13px;font-weight:normal;line-height:22px;margin:13px 0 12px 9px;text-align:left;">Dear <span style="font-weight: bold;">Customer</span>,
                        ...
                        <p style="font-size:13px;line-height:16px;margin: 0px 12px 8px 9px;text-align:left;">
                            We are unable to complete your order at http://www.laksyah.com due to Transaction Failure.
                        </p>
                        <p style="font-size:13px;line-height:16px;margin: 0px 12px 8px 9px;text-align:left;">
                            We invite you to visit tp://www.laksyah.com once more to place this order, using credit card or online bank account or laksyah credit amount.
                        </p>
                        <p style="font-size:13px;line-height:16px;margin: 0px 12px 8px 9px;text-align:left;">
