            ...
            <div class="col-sm-5 col-md-4 product_details_sidebar">
                <div class="product_metas">
                    ...
                    <?php if ($product->enquiry_sale == 1) { ?>
                            <div class="product_price"><span class="old_price"><?php echo Yii::app()->Currency->convert($product->price) ?></span> <span class="discounted"><?php echo Yii::app()->Discount->Discount($product); ?></span></div>
