...
<!--                                                                <li><a href="#" data-image="<?= Yii::app()->request->baseUrl; ?>/images/product_big2.jpg" data-zoom-image="<?= Yii::app()->request->baseUrl; ?>/images/product_lg.jpg"> <img src="<?= Yii::app()->request->baseUrl; ?>/images/product_small.jpg" alt=""/> </a></li>
                        ...
                        <div class="col-sm-5 col-md-4 product_details_sidebar">
                                <div class="product_metas">
                                        ...
                                        <div class="product_ID">SKU: <?php echo $product->product_code;                                                                                                                           ?></div>
                                                                                ...
                                                                                <div class="sold_out_notify">
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                                <?php if (isset(Yii::app()->session['user'])) { ?>
                                                                                                        <input type="email" class="form-control"  id="email" required=""  name="email" value="<?= Yii::app()->session['user']['email'] ?>">
                                                                                                        <?php
                                                                                                } else {
                                                                                                        ?>
                                                                ...
                                                                if ($total_stock == 0 || $out_stock == 0) {
                                                                        ...
                                                                        <form action = "<?= Yii::app()->baseUrl; ?>/index.php/products/ProductNotify/id/<?= $product->id; ?>" method = "post" name = "notify">
                                                                                ...
                                                                                <div class="sold_out_notify">
                                                                                        ...
                                                                                        <div class="input-group">
                                                                                                <?php if (isset(Yii::app()->session['user'])) { ?>
                                                                                                        <input type="email" required="" class="form-control"  id="email"  name="email" value="<?= Yii::app()->session['user']['email'] ?>">
                                                                                                        <?php
                                                                                                } else {
                                                                                                        ?>
                                                                                                        <input type="email" required="" class="form-control" id="email" name="email"  placeholder="Enter Email Address">
                                                                                                        <?php
                                                                                                }
                                                                                                ?>
                                                                                                <div class="input-group-btn"><button type="submit" class="btn-primary btn">Notify Me</button></div>
                                        ...
                                        if (!empty($product_option)) {
                                                ...
                                                if ($product_option->option_type_id == 2 || $product_option->option_type_id == 3) {
                                                        ...
                                                        <div class = "product_size size_filter">
                                                                <h3>Select Size&nbsp;&nbsp;<span><a href = "#" data-toggle = "modal" data-target = "#sizechartModal">VIEW SIZE CHART </a>&nbsp; (<?php
                                                ...
                                                <div class="modal-dialog">
                                                        <div class="modal-content">
                                                                ...
                                                                <div class="modal-body">
                                                                        <div>Provide your information and we will contact you shortly. All information you provide will be treated confidentially. </div><br/>
                                                                                ...
                                                                                <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                                <div class="modal-footer">
                                                                                                        <?php echo CHtml::submitButton($model->isNewRecord ? 'GET QUOTE' : 'Save', array('class' => 'btn btn-primary')); ?>
