                                                                ...
                                                                if (!empty($colors)) {
                                                                        ...
                                                                        <ul class = "product_colors">
                                                                                ...
                                                                                foreach ($colors as $color) {
                                                                                        ...
                                                                                        ?>
                                                                                        <li style="<?php echo $style; ?>" class = "<?php echo $disabled1; ?>" option_id="<?php echo $product_option->id; ?>" color="<?php echo $color->color_id; ?>"> <a class = "#" style = "background-color:<?php echo $color_name->color_code; ?>;" title="<?php echo $color_name->color_name; ?>"></a> </li>
                                                                ...
                                                                if (!empty($sizes)) {
                                                                        ...
                                                                        <div class = "size_selector">
                                                                                ...
                                                                                foreach ($sizes as $size) {
                                                                                        ...
                                                                                        ?>
                                                                                        <label style="<?php //echo $style1;      ?>" class="<?php echo $disabled; ?>" id="<?php echo $size->size_id; ?>"><?php echo $size_name->size; ?>
                                                                                ...
                                                                                <div class="row">
                                                                                        <div class="col-sm-12">
                                                                                                <div class="modal-footer">
                                                                                                        <?php echo CHtml::submitButton($model->isNewRecord ? 'GET A QUOT' : 'Save', array('class' => 'btn btn-primary')); ?>
