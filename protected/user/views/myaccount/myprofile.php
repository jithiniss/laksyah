                        ...
                        <div class="registration_form">
                                <div class="row">
                                        <div class="col-sm-6">
                                                ...
                                                <?php echo $form->dropDownList($model, 'title', array('Ms' => "Ms", 'Mrs' => "Mrs", 'Mr' => "Mr"), array('class' => 'form-control', 'readOnly' => true)); ?>
                                ...
                                <div class="row">
                                        <div class="col-sm-6">
                                                ...
                                                <?php echo CHtml::activeDropDownList($model, 'country', CHtml::listData(Countries::model()->findAll(), 'id', 'country_name'), array('class' => 'form-control ', 'readOnly' => true, 'options' => array($model->country => array('selected' => 'selected')))); ?>
