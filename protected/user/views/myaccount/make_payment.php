                                ...
                                <div class="row">
                                        ...
                                        <div class="col-sm-6">
                                                <div class="price_group payment_method">
                                                        ...
                                                        <label class="radio_group"><?php echo $form->radioButtonList($model, 'payment_mode', array('1' => ''), array('uncheckValue' => null, 'hidden' => 'true')); ?></label>
                                                        <strong class="radio_label pull-left">CREDIT/DEBIT/NET BANKING </strong>
                                                        <label class="radio_group "><?php echo $form->radioButtonList($model, 'payment_mode', array('2' => ''), array('uncheckValue' => null, 'hidden' => 'true')); ?></label>
                                                        <strong class="radio_label pull-left">PAYPAL</strong>
                                                        <div class="clearfix"></div>

                                                </div>
                                                <?php echo $form->error($model, 'payment_mode', array('style' => 'color:red')); ?>
                                        </div>
                                </div>
                                <div class="row">
                                        <div class="col-sm-3">
